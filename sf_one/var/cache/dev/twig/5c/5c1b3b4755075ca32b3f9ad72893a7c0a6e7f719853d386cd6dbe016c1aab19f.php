...
class __TwigTemplate_802ea37dea1e1ec2439c5294583d045ab5490d038124533cd140d5742bad1219 extends Template
{
    private $source;
    private $macros = [];
...
\t";
        // line 8
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 8, $this->source); })()), "username", [], "any", false, false, false, 8), 'row', ["label" => "Nom d'utilisateur", "attr" => ["placeholder" => "Nom d'utilisateur..."]]);
        echo "

\t";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "email", [], "any", false, false, false, 10), 'row', ["label" => "Adresse Email", "attr" => ["placeholder" => "Adresse email..."]]);
        echo " 
\t";
        // line 11
...
\t";
        // line 14
        echo "\t<button type=\"submit\" class=\"btn btn-success\">Inscription</button>
\t";
        // line 15
...
";
    ...
    {
        return array (  97 => 15,  94 => 14,  90 => 12,  86 => 11,  82 => 10,  77 => 8,  72 => 6,  68 => 4,  58 => 3,  35 => 1,);
    }
...
\t{{ form_row(form.confirm_password, {'label': 'Confirmation du mot de passe','attr': {'placeholder': 'Répéter votre mot de passe' }}) }} 
\t{# widget: afficher champs formulaire #}
\t<button type=\"submit\" class=\"btn btn-success\">Inscription</button>
\t{{ form_end(form) }}

{% endblock %}", "security/registration.html.twig", "/var/www/html/sf_one/templates/security/registration.html.twig");
    }
}
